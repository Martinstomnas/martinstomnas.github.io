window.onload = function() {
    setBackgroundColor("rgb(255, 178, 102)") // himmel
     
       
    circleCanvas(225, 200, 100, "solid","yellow") // sol
    circleCanvas(100, 75, 25, "solid","white") // sky
    ...
    rectangleCanvas(0, 220, 500, 20, "solid", "rgb(57, 135, 230)") // vann
}
//js

document.addEventListener("DOMContentLoaded", function() {

    rectangleSVG(0, 0, 500, 500, "solid", "rgb(255, 178, 102)")
    circleSVG(225, 200, 100, "solid","yellow") // sol
    ...
    rectangleSVG(0, 410, 500, 90, "solid", "rgb(205, 170, 109)") // sand   
